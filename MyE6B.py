...
frame_alt = sg.Frame(layout = [[sg.Text('Indicated alt.:', size = (10, 1)), sg.InputText('0', key = 'altitude_ind', size = (10, 1), do_not_clear = True), 
                                sg.Text('Altimeter setting (inHg):', size = (25, 1), justification = 'right'), sg.InputText('29.92', key = 'altimeter', size = (10, 1), do_not_clear = True),
                                sg.Text('Temperature (C):', size = (25, 1), justification = 'right'), sg.InputText('15', key = 'temperature', size = (10, 1), do_not_clear = True),
                                sg.Text('KIAS:', size = (25, 1), justification = 'right'), sg.InputText('100', key = 'kias', size = (10, 1), do_not_clear = True)],
                               [sg.Text('Pressure alt.:', size = (10, 1)), sg.Text('1000', key = 'altitude_pressure', size = (25, 1)), 
                                sg.Text('Density alt.:', size = (10, 1), justification = 'right'), sg.Text('1000', key = 'altitude_density', size = (10, 1)),
                                sg.Text('KTAS.:', size = (10, 1), justification = 'right'), sg.Text('1000', key = 'ktas_out', size = (10, 1))],
...
frame_wind = sg.Frame(layout = [[sg.Text('Wind dir.:', size = (10, 1)), sg.InputText('0', key = 'wind_direction', size = (10, 1), do_not_clear = True), 
                                 sg.Text('Wind spd:', size = (25, 1), justification = 'right'), sg.InputText('0', key = 'wind_speed', size = (10, 1), do_not_clear = True),
                                 sg.Text('KTAS:', size = (25, 1), justification = 'right'), sg.InputText('0', key = 'ktas_in', size = (10, 1), do_not_clear = True),
                                 sg.Text('True course:', size = (25, 1), justification = 'right'), sg.InputText('0', key = 'true_course', size = (10, 1), do_not_clear = True)],
                                [sg.Text('WCA:', size = (10, 1)), sg.Text('0', key = 'wca', size = (25, 1)), 
                                 sg.Text('True HDG:', size = (10, 1), justification = 'right'), sg.Text('1000', key = 'true_heading', size = (10, 1)),
                                 sg.Text('Ground spd:', size = (10, 1), justification = 'right'), sg.Text('1000', key = 'ground_speed', size = (10, 1))],
                                [sg.ReadButton('Calculate', key = 'calcWindCorr', size = (15, 1))]],
                      title = 'Wind correction', relief = sg.RELIEF_SUNKEN)
frame_flt = sg.Frame(layout = [[sg.Text('Distance:', size = (25, 1), justification = 'right'), sg.InputText('0', key = 'distance', size = (10, 1), do_not_clear = True),
                                sg.Text('Fuel rate (GPH):', size = (25, 1), justification = 'right'), sg.InputText('7.8', key = 'fuel_rate', size = (10, 1), do_not_clear = True)],
                               [sg.Text('Time:', size = (10, 1)), sg.Text('0', key = 'time', size = (25, 1)), 
                                sg.Text('Fuel:', size = (10, 1)), sg.Text('0', key = 'fuel', size = (25, 1))],
